---
layout: content.njk
title: "Athletic Scholarships: How They Actually Work (Post-House-Settlement Reality) | RosterWise™"
description: "How college athletic scholarships work after the House settlement — head count vs. equivalency (now changed), full vs. partial, by division, and what families should realistically expect."
date: 2026-04-26
breadcrumbs:
  - text: Home
    url: /
...
sources:
  - "NCAA.org, Scholarship and Financial Aid guidelines"
  ...
  - "NAIA.org, Scholarship information"
...
Schools in the five defendant conferences (the ACC, Big Ten, Big 12, Pac-12 and SEC) are bound by the settlement as defendants rather than by opting in. Every other D1 school chooses: non-defendant institutions had until June 30, 2025 to opt in for 2025-26, and from 2026-27 onward must give notice of intent by March 1 each year. Schools that did not opt in retain the traditional scholarship structure (sport-specific equivalency/head count caps) but cannot share revenue with athletes.
...
- **Factor in all aid.** Athletic scholarship + academic merit aid + need-based aid = total financial aid package. Look at the complete picture. See our [guide to stacking financial aid](/guide/stacking-financial-aid/) for how these layers interact and where the ceiling sits. NIL and revenue sharing are separate compensation pathways — see our [NIL guide](/guide/nil-and-revenue-sharing/) for what non-revenue sport families should realistically expect.
...
**"A verbal scholarship offer is locked in."** A verbal offer is not a financial commitment at all. The commitment exists once a written offer of athletics aid is signed (or, at D3, in the institution's financial aid award letter) — that is what commits the school to the aid it specifies. See our [verbal commitment guide](/guide/verbal-commitment-vs-nli/).
...
*Scholarship structures changed with the House settlement and continue to change each legislative cycle. This article reflects the **2025-26** academic year. Verify current scholarship and roster limits at NCAA.org, NAIA.org, and NJCAA.org, and confirm what a specific program actually funds with its coaching staff.*
