---
layout: content.njk
title: "How to Make a Recruiting Highlight Video That Coaches Will Watch | RosterWise™"
description: "A practical guide to creating recruiting highlight videos — what coaches want to see, how long it should be, common mistakes, and budget-friendly tips."
date: 2026-05-20
breadcrumbs:
  - text: Home
    url: /
...
1. **Title card (5-10 seconds).** Athlete name, jersey number, position, graduation year, high school, club team, height/weight (if relevant to the sport), and contact information (email or phone). Some families include GPA and test scores here.

2. **Best clips first (first 60-90 seconds).** Open with the strongest, most impressive footage. This is the section that determines whether a coach keeps watching. Show range — different skills, different game situations, different opponents.

3. **Additional highlights (next 2-3 minutes).** Continue with strong clips organized by skill type or game situation. Some athletes organize by category (defensive plays, offensive plays, set pieces) and others go chronologically. Either approach works — the important thing is that every clip earns its spot.

4. **Closing card (5 seconds).** Repeat the athlete's name, contact information, and a link to full-game film if available.
...
For more on how to approach coaches, see our [recruiting timeline guide](/guide/recruiting-timeline/) and [NCAA recruiting rules guide](/guide/ncaa-recruiting-rules/).
