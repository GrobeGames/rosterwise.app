---
layout: content.njk
title: "Recruiting Questionnaires: Why You Should Fill Them Out (and What Happens Next) | RosterWise™"
description: "College recruiting questionnaires explained — why they matter, when to fill them out, what happens after you submit, and what they really mean for your recruiting journey."
date: 2026-05-24
breadcrumbs:
  - text: Home
    url: /
...
sources:
  - "NCAA.org, Division I Recruiting Calendars and Guides (2026-27)"
...
faq:
  - q: "If I fill out a questionnaire, does that mean I'm being recruited?"
    a: "No. A questionnaire is how you raise your hand and express interest. Coaches deciding to actively recruit you is a separate step that depends on your athletic ability, academic profile, roster needs, and many other factors."
  - q: "Did a coach send me a questionnaire link because they want me?"
    a: "Not necessarily. Coaches often send questionnaire links to large pools of athletes to gauge interest and build their database. The questionnaire link is an invitation to share your information — it's not an indication of active recruitment."
  - q: "Am I too young to fill out a recruiting questionnaire?"
    a: "Generally no — questionnaires can be completed at any age. That said, freshman-year submissions may not receive much attention from coaches. Sophomore year onward is when most families begin filling them out."
  - q: "If I skip the questionnaire, will the coach find me anyway?"
    a: "Sometimes — if you're elite enough to be on the national radar. But for most athletes, skipping the questionnaire means missing the entry point that programs use to build their recruiting database."
  - q: "Does filling out lots of questionnaires get me more attention?"
    a: "Quality matters more than quantity. Twenty thoughtful, well-targeted submissions for programs you've genuinely researched are more useful than a hundred copy-paste submissions to random schools."
cta:
...
**It puts you on the radar before formal contact is allowed.** This is the most important and least understood point. NCAA Division I coaches in most sports cannot initiate substantive recruiting communication — calls, texts, personalized recruiting emails — until June 15 after a recruit's sophomore year (some sports hold it back to the start of junior year). But questionnaires are categorized by the NCAA as non-recruiting materials and are exempt from these contact-date restrictions. Athletes can fill them out at any age, and coaches can collect questionnaire data at any time. This makes the questionnaire one of the few ways to get on a D1 program's radar before the formal contact window opens. See our [NCAA recruiting rules guide](/guide/ncaa-recruiting-rules/) for sport-specific contact dates — and note that sport-specific timing matters, particularly for lacrosse, where women's opens September 1 of junior year and men's opens the Wednesday after Labor Day of junior year (see [The September 1 Junior Year Rule](/lacrosse/guide/september-1-junior-year-rule/)).
...
- **NCAA Eligibility Center ID** — if you've registered (see our [NCAA Eligibility Center guide](/guide/ncaa-eligibility-center/))
...
- **Highlight video link** — if you have one, include it (see our [highlight video guide](/guide/highlight-video/) for what coaches want to see)
...
For sport-specific timelines, see our [general recruiting timeline](/guide/recruiting-timeline/) or the sport-specific guides for [men's soccer](/soccer/mens/guide/recruiting-timeline/), [women's soccer](/soccer/womens/guide/recruiting-timeline/), and [women's volleyball](/volleyball/womens/guide/recruiting-timeline/).
...
1. **Research programs** — understand which programs align with your athlete's athletic and academic profile. This is where [roster intelligence](/roster-intelligence/) provides the deepest value.
2. **Fill out questionnaires** — for your target programs, expressing interest and providing your information
3. **Email coaches directly** — personalized outreach that reinforces your questionnaire submission (see [contacting coaches](/guide/contacting-coaches/))
4. **Develop and share highlight film** — the visual evidence coaches need (see [highlight video](/guide/highlight-video/))
5. **Attend showcases, ID camps, and games** — where coaches evaluate in person
6. **Continue engagement** — through the contact windows with ongoing communication
7. **Visits, conversations, and decisions** — the final evaluation and commitment process
