---
layout: hub.njk
title: "College Recruiting Guide — RosterWise™"
description: "A practical guide to college sports recruiting for families. Timelines, rules, scholarships, the transfer portal, and how to navigate the process."
breadcrumbs:
  - text: Home
    url: /
  - text: Guide
...
This guide covers the universal aspects of college sports recruiting — the rules, structures, and strategies that apply across sports. For sport-specific content, see our [Soccer](/soccer/) section (more sports coming soon).
