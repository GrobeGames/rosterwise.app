---
layout: content.njk
title: "10 Questions Every Family Should Ask a College Coach | RosterWise™"
description: "Practical, specific questions to ask college coaches during the recruiting process — and why each one matters for making an informed decision."
date: 2026-04-26
breadcrumbs:
  - text: Home
    url: /
...
cta:
  heading: "Ask the right questions. Bring the right data."
...
**Red flag:** Vague answers or unwillingness to discuss role specifics. See our [red flags guide](/guide/recruiting-red-flags/).
...
For more context, see our [athletic scholarships guide](/guide/athletic-scholarships/).
...
For more context, see our [transfer portal guide](/guide/transfer-portal/).
...
For more context, see our [scholarships guide](/guide/athletic-scholarships/) and [walk-on guide](/guide/walk-on-types/).
