---
layout: content.njk
title: "Academic Eligibility for College Athletics: NCAA Eligibility Center Basics | RosterWise™"
description: "How to register with the NCAA Eligibility Center, core course requirements, GPA and test score sliding scales, and what families need to know about academic eligibility."
date: 2026-04-26
breadcrumbs:
  - text: Home
    url: /
...
sources:
  ...
  - "NCAA.org, Division I Academic Requirements"
  - "NCAA.org, Division II Academic Requirements"
...
- Athletes going to **NAIA** schools (NAIA has its own eligibility center at [play.mynaia.org](https://play.mynaia.org))
...
**Registration link:** [eligibilitycenter.org](https://eligibilitycenter.org)
...
**NAIA:** Uses its own eligibility center at [play.mynaia.org](https://play.mynaia.org). An incoming freshman qualifies with a **final overall high school GPA of 2.3 or higher — that alone is enough**. Athletes below a 2.3 GPA can still qualify by meeting **two of three criteria:**
1. Minimum overall GPA of 2.0
2. Minimum ACT composite of 18 or SAT total of 970
...
International students have additional requirements, including course-by-course credential evaluation through an NCAA-approved agency. See our [international student-athletes guide](/guide/international-student-athletes/) for details.
