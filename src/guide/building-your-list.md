---
layout: content.njk
title: "Building Your Recruiting List — A Practical Framework | RosterWise™"
description: "How to build a college recruiting target list — academic fit, roster analysis, geographic preferences, financial reality, and honest self-assessment."
date: 2026-05-20
breadcrumbs:
  - text: Home
    url: /
...
**This is the kind of analysis [RosterWise](/app/) is built to provide** — roster-level data at every program, so families can evaluate athletic fit based on evidence rather than guesswork.
...
- **What athletic scholarship money is available?** This varies by sport, division, and program budget. See our [scholarship guide](/guide/athletic-scholarships/) for how the current system works.
...
Visit campuses — officially and unofficially. Talk to coaches in depth. Meet current players. Evaluate the experience firsthand. Our [visits guide](/guide/official-vs-unofficial-visits/) covers what to look for.

Your list narrows to 5-8 serious contenders.

### Phase 4: Decision (senior year)

Evaluate offers, compare financial packages, and choose the program that fits best across all dimensions — athletic, academic, financial, personal. See our [verbal commitment guide](/guide/verbal-commitment-vs-nli/) for how commitments work.
...
- **Red flags appear** — see our [recruiting red flags guide](/guide/recruiting-red-flags/)
