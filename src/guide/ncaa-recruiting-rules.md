---
layout: content.njk
title: "NCAA Recruiting Rules Explained: Contact Periods, Dead Periods, Quiet Periods | RosterWise™"
description: "A plain-language guide to NCAA recruiting rules — contact periods, dead periods, quiet periods, evaluation periods, and how they differ across D1, D2, and D3."
date: 2026-04-26
breadcrumbs:
  - text: Home
    url: /
...
The NCAA can impose penalties on the institution and the coaching staff. Families who suspect a violation can report it, but should not feel responsible for policing rules. If something feels off during the recruiting process, that's worth noting — see our [recruiting red flags guide](/guide/recruiting-red-flags/).
...
Visit [NCAA.org](https://www.ncaa.org) and search for "recruiting calendar" plus your sport and division. The NCAA publishes sport-specific calendars for each academic year.
