...
related:
  ...
  - title: "D1 vs. D2 vs. D3 vs. NAIA: What's the Actual Difference?"
...
cta:
  heading: "Rules change. Rosters still decide fit."
  text: "Eligibility rules are in flux, but the question underneath recruiting hasn't moved: who is already on the roster, and when do they leave? RosterWise analyzes every program — position or weight-class depth, class-year gaps, transfer patterns, recruiting geography, and the school itself — so your family can build a target list on facts."
...
1. **First full-time enrollment** — the academic term when the athlete first enrolls full time and attends class at **any** college or university; **or**
2. **The age trigger** — the start of the regular academic year immediately following the athlete's **19th birthday**, if they turn 19 before September 1. (For athletes turning 19 on or after September 1, the period begins the following academic year unless they enroll earlier.)
...
If you're weighing that path, our [junior college (JUCO) guide](/guide/njcaa-juco-explained/) covers how the NJCAA works, what transferring on actually requires, and — importantly — which outcome claims are and aren't backed by verified data.
...
One practical consequence deserves its own note. The [House v. NCAA settlement](/guide/house-settlement/) moved Division I from scholarship limits to **roster limits**. The August 3 clarification confirmed the injunction does **not** lift those roster caps.
...
1. **Don't make an irreversible decision based on unsettled rules.** A gap year, a reclassification, or a prep year is a real commitment. The rules governing it are, right now, under appeal.
2. **Get your athlete's specific window confirmed in writing** by the NCAA Eligibility Center or a compliance officer — not from a forum, a highlight-tape service, or this page.
3. **Ask coaches directly** how they're reading the interaction between fifth-year returners and roster limits for the class you're in.
