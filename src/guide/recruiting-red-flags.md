---
layout: content.njk
title: "Red Flags to Watch for During the Recruiting Process | RosterWise™"
description: "Warning signs families should watch for during college recruiting — pressure tactics, vague financial information, coaching turnover, and other red flags that signal a program may not be the right fit."
date: 2026-04-26
breadcrumbs:
  - text: Home
    url: /
...
sources:
  - "NCAA.org, Recruiting guidelines and compliance resources"
...
See our [athletic scholarships guide](/guide/athletic-scholarships/) for context on what to expect.
...
See our [visit guide](/guide/official-vs-unofficial-visits/) for more on making the most of campus visits.
...
See our [transfer portal guide](/guide/transfer-portal/) for more context.
...
Compare what the coach is telling you against the roster data. If a coach says "You'll start at center back as a freshman" but the roster has three center backs returning with starting experience, ask follow-up questions. Use [RosterWise](/app/) to verify roster composition and position depth.
