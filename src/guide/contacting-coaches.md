---
layout: content.njk
title: "How to Communicate with College Coaches — What to Say and When | RosterWise™"
description: "What to say in your first email to a college coach, how to follow up, what coaches care about, and common communication mistakes recruiting families make."
date: 2026-05-20
breadcrumbs:
  - text: Home
    url: /
...
summary: "Reaching out to college coaches is one of the most important — and most anxiety-inducing — parts of the recruiting process. Most families overthink it. This guide covers what to include in that first email, how to follow up without being annoying, what coaches actually care about, and the common mistakes that hurt more than they help."
related:
...
sources:
  - "NCAA.org, Recruiting guidelines and contact rules"
...
- **Video link.** This is critical. A link to a highlight reel or full-game film, clearly labeled. Not an attachment — a link. See our [highlight video guide](/guide/highlight-video/) for what coaches want to see.
...
- **Division II:** D2 coaches have more flexibility on communication. There is no initial-contact date on calls, texts, email, or recruiting materials — Bylaw 13.1.3.1 provides that communication "shall be made at any time." **In-person off-campus contact and official visits are a different matter:** those open after June 15 immediately preceding junior year (2026-27 Division II Coaches Off-Campus Recruiting Guide). D2 runs a single all-sports recruiting calendar, and for 2026-27 the only closed window is a signing-date dead period from 7 a.m. November 9 to 7 a.m. November 11, 2026.
- **Division III:** D3 coaches have the fewest communication restrictions. D3 has no recruiting calendar at all — no dead periods, quiet periods, contact periods, or evaluation periods. Coaches can respond to athletes at any time. The one timing rule is that in-person off-campus contact may not occur until the athlete has completed sophomore year.
