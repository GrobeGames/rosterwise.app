---
layout: content.njk
title: "What Men's Volleyball Coaches Look For"
description: "What men's college volleyball coaches actually evaluate — physical profile, position-specific skills, intangibles, and academic profile across divisions."
date: 2026-06-14
breadcrumbs:
  - text: Home
    url: /
...
related:
  - title: "Position-Specific Recruiting"
    url: /volleyball/mens/guide/position-specific-recruiting/
    status: live
  ...
  - title: "Recruiting Video"
    url: /volleyball/mens/guide/recruiting-video/
    status: live
  - title: "ID Camps"
    url: /volleyball/mens/guide/id-camps/
    status: live
sources:
...
1. **Physical profile** — Height, vertical jump (approach and block), standing reach, wingspan, body type.
2. **Technical skills** — Mechanics across the position-specific skill set.
3. **Volleyball IQ and game sense** — Reading the play, decision-making, positioning, anticipation.
4. **Intangibles** — Composure, coachability, work ethic, communication, leadership.
5. **Academic profile** — Grades, test scores (when applicable), and fit with the institution's academic standards.
...
The position-specific emphasis is covered in more detail in our [position-specific recruiting guide](/volleyball/mens/guide/position-specific-recruiting/).
