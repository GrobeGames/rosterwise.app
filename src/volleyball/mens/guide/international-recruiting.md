...
related:
  ...
  - title: "What Coaches Look For"
    ...
    status: live
  - title: "Universal International Athletes Guide"
    url: /guide/international-student-athletes/
    status: live
  - title: "NCAA Eligibility Center Guide"
    url: /guide/ncaa-eligibility-center/
    status: live
sources:
  - "NCAA Eligibility Center — International initial-eligibility certification"
  - "USA Volleyball — General college recruitment guidance for international and domestic recruits"
  - "FIVB (Fédération Internationale de Volleyball) — Junior international competition documentation"
  - "Publicly available NCAA program roster data"
cta:
