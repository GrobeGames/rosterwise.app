...
related:
  - title: "Recruiting Timeline"
    url: /volleyball/mens/guide/recruiting-timeline/
    status: live
  - title: "Scholarships After the House Settlement"
    url: /volleyball/mens/guide/scholarships/
    status: live
  - title: "The Combined D1/D2 National Collegiate Championship"
    url: /volleyball/mens/guide/national-collegiate-championship/
    status: live
  - title: "Club Pathways"
    url: /volleyball/mens/guide/club-pathways/
    status: live
  - title: "What Coaches Look For"
    url: /volleyball/mens/guide/what-coaches-look-for/
    status: live
sources:
...
Our guide [The Combined D1/D2 National Collegiate Championship](/volleyball/mens/guide/national-collegiate-championship/) explains this structure in more detail.

## Program counts by division

Program counts are one of the places where being precise about the source matters, because the NCAA publishes more than one number and they do not agree. We give both, with the basis named.

**NCAA men's volleyball — most recent actual data.** The NCAA's *Sports Sponsorship and Participation Rates Report* (updated September 4, 2025) reports for **2024-25**: Division I **26**, Division II **44**, Division III **128** — **198** NCAA programs overall. The NCAA cautions that the report is built from self-reported institutional data, that "no specific checks were made to verify the information," and that it includes provisional members.

**NCAA men's volleyball — most recent projection.** The NCAA's *Projected Sport Sponsorship* table, "as of September 2025," projects for **2025-26**: Division I **31**, Division II **43**, Division III **132** — **206** overall. The NCAA labels these "projected numbers only; actual numbers may change."

A third NCAA figure exists and is worth knowing if you see it quoted: an NCAA release of August 6, 2026 states that "Division II had 36 schools sponsor men's volleyball during the 2025-26 academic year, with that number expected to reach 44 in 2026-27." That counts active D2 members, where the research report includes provisional ones.
...
**Far fewer programs.** Under 300 men's college volleyball programs exist nationally, against 1,055 NCAA women's volleyball programs before the NAIA and NJCAA are counted. This means fewer programs to evaluate, but also fewer roster spots overall.
...
Our [recruiting timeline guide](/volleyball/mens/guide/recruiting-timeline/) walks through what the timeline looks like in practice, including how to navigate the slower pace, when to start outreach, and how the club volleyball season interacts with the recruiting calendar.
...
Our [men's volleyball scholarships guide](/volleyball/mens/guide/scholarships/) explains the pre-settlement reality, the post-settlement reality, and what families should be asking coaches in this transitional period.
...
The boys' club volleyball ecosystem is significantly smaller than the girls' club ecosystem. Fewer clubs, fewer National Qualifiers (BNQs), and more geographic concentration. We cover the full picture in our [club pathways guide](/volleyball/mens/guide/club-pathways/).

## Growth of the sport

Men's college volleyball is growing. The NCAA's own Sports Sponsorship and Participation Rates Report tracks sponsorship back to 1956-57 and is the place to check the trend. On its most recent actual data, D1 men's volleyball stood at 26 programs in 2024-25; the NCAA projects 31 for 2025-26. We are not restating a longer year-by-year series here, because the figures that circulate for earlier years do not all trace to that report.

The high school participation picture points the same way, with one caveat worth carrying.

The National Federation of State High School Associations (NFHS) reports **95,972** boys playing high school volleyball at **4,303 schools** in its 2024-25 High School Athletics Participation Survey. In an August 22, 2025 column, the NFHS states that "in the past three years, the number of boys playing volleyball has jumped from **66,487** to 95,972." The NFHS does not attach an academic year to the 66,487 figure — it frames the comparison only as "the past three years" — so we do not put one on it either.

**The caveat:** the number of state associations reporting boys' volleyball participation to the NFHS has itself risen over that period, from 25 to 32. Part of the measured growth is real and part of it is wider coverage, and the NFHS does not separate the two. The direction of travel is not in doubt; the precise size of the jump is softer than a bare percentage would suggest.

Two figures that circulate from the same NFHS column we are deliberately not restating as fact. The NFHS says boys' volleyball "is now No. 11 on the list of top sports," but that ranking is not reproducible from the NFHS's own participation table, which puts boys' lacrosse ahead of it — and the NFHS's own published boys' top-ten list excludes volleyball altogether. The same column says "25 state associations are now conducting state volleyball championships for boys," which the survey itself carries no data to support. Where two NFHS statements disagree, we would rather say so than pick one.
...
1. **[The Recruiting Timeline](/volleyball/mens/guide/recruiting-timeline/)** — when contact begins, when to start outreach, what each year looks like
2. **[Scholarships After the House Settlement](/volleyball/mens/guide/scholarships/)** — the most significant structural change in the sport
3. **[The Combined D1/D2 National Collegiate Championship](/volleyball/mens/guide/national-collegiate-championship/)** — understanding the unique structure of the top level
4. **[Club Pathways](/volleyball/mens/guide/club-pathways/)** — how the BJNC and the boys' club volleyball ecosystem fit into recruiting
5. **[What Coaches Look For](/volleyball/mens/guide/what-coaches-look-for/)** — physical priorities and skill expectations by position
6. **[Position-Specific Recruiting](/volleyball/mens/guide/position-specific-recruiting/)** — outside hitter, middle blocker, setter, opposite, libero
7. **[ID Camps](/volleyball/mens/guide/id-camps/)** — how to choose and what to expect
8. **[Recruiting Video](/volleyball/mens/guide/recruiting-video/)** — what to film, what to include, how to share
