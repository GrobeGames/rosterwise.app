...
- **Women's volleyball was a head count sport.** Before the House settlement, D1 programs had 12 scholarship slots and no NCAA cap on roster size. With limited scholarship spots, coaches felt pressure to identify and secure commitments early — and families felt corresponding pressure to commit before spots filled.
...
For a detailed breakdown of the USA Volleyball ecosystem, JNQs, GJNC divisions, and what it all means for recruiting, see our [club pathways guide](/volleyball/womens/guide/club-pathways/).
...
- By sophomore year: NCAA Eligibility Center registration ([eligibilitycenter.org](https://eligibilitycenter.org))
...
*NCAA recruiting calendars are updated annually. This article reflects the **2026-27** NCAA Division I Women's Volleyball Recruiting Calendar. Verify the current calendar at `ncaaorg.s3.amazonaws.com` for the relevant academic year, check NAIA.org and NJCAA.org for those associations' rules, and confirm academic timing with the NCAA Eligibility Center.*
