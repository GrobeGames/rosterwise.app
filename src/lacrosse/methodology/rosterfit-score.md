...
description: "A transparent explanation of how RosterWise calculates My RosterFit scores — the eight factors that determine how well a recruit fits a college lacrosse program."
date: 2026-06-14
breadcrumbs:
  - text: Home
    url: /
...
summary: "My RosterFit™ is the scoring system at the heart of RosterWise. It evaluates how well a specific recruit's profile matches a specific college lacrosse program across eight factors: Position Need, Academic Match, Roster Composition, Pathway Alignment, Height Fit, Geographic Fit, Financial Fit, and Division Level. This page explains what each factor measures, why it matters, and how families should interpret the results."
related:
...
cta:
  ...
  text: "My RosterFit scores for every college lacrosse program in the country — personalized to your athlete's position (including FOGO, LSM, SSDM, goalie, and traditional positions), size, academics, geography, and preferences. Men's and women's. See where your athlete fits."
...
My RosterFit™ is a scoring system that evaluates how well a specific recruit's profile aligns with a specific college lacrosse program. It's personalized — the same program will receive different RosterFit scores for different recruits, because fit depends on the individual.
...
**Why it matters:** A program with three senior close defenders graduating next spring has a demonstrable need for a defender. A program with two freshman defenders and a sophomore does not. Position Need captures the gap between where the roster is and where it needs to be at the recruit's position.
...
**What it measures:** The overall structural fit between the recruit's profile and the program's roster — beyond just position. This includes class-year balance, roster size relative to the post-House-settlement caps, and the general health of the roster's composition.
...
**What we look at:** Class-year distribution across the full roster, total roster size, the balance of returning players versus expected departures, and (for D1 programs) how the roster compares to the new House Settlement caps (48 men's, 38 women's).
...
**What we look at:** Hometowns and states (and countries) of current roster players, compared to the recruit's location. Also, the program's general geographic recruiting radius.
