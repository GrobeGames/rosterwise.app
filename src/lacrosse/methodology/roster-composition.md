...
description: "How roster composition analysis works, what it reveals about college lacrosse programs, and why families should use it to make smarter recruiting decisions."
date: 2026-06-14
breadcrumbs:
  - text: Home
    url: /
...
This is especially important in lacrosse after the [House v. NCAA settlement](/lacrosse/guide/house-settlement-and-lacrosse/), which set firm D1 roster caps (48 for men's, 38 for women's). With fixed roster sizes, every spot matters more, and understanding where programs have genuine need at your athlete's position is more valuable than ever.
