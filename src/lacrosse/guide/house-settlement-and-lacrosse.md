---
layout: content.njk
title: "The House Settlement and Lacrosse: What Changed in 2025 | RosterWise™"
description: "The House v. NCAA settlement dramatically reshaped college lacrosse scholarships and rosters in 2025. Men's D1 scholarships jumped from 12.6 to 48; women's from 12 to 38. Here's what families need to understand."
date: 2026-06-14
breadcrumbs:
  - text: Home
    url: /
...
related:
  ...
  - title: "NIL and Revenue Sharing for Families"
...
faq:
  - q: "Do all D1 men's lacrosse programs now offer 48 scholarships?"
    a: "No. 48 is the maximum allowed at opt-in schools, not a requirement. Many programs will continue funding at previous levels or below. Families should ask each program directly about its scholarship funding."
  - q: "Are walk-on opportunities at D1 lacrosse eliminated?"
    a: "No. Walk-on opportunities still exist at many D1 programs, but they're now competing for the same total roster spots as scholarship players. Some programs that previously carried 50+ players now cap at 48."
  - q: "Does the settlement mean lacrosse recruits will all get full scholarships?"
    a: "No. The settlement allows programs to offer more scholarships to more athletes, but partial scholarships remain common in lacrosse (an equivalency sport historically). The mix of full and partial scholarships at a specific program depends entirely on that program's funding choices."
  - q: "My athlete was a walk-on at a D1 program before the settlement — are they protected as a DSA?"
    a: "Only if the athlete was identified as a Designated Student-Athlete by the July 6, 2025 deadline. Athletes who were rostered but not designated as DSAs by that date do not have grandfather protection."
  - q: "Did women's D1 lacrosse benefit the most from the settlement?"
    a: "Women's lacrosse did expand scholarship limits significantly (from 12 to 38) and avoided the roster reduction impact that hit men's lacrosse. But whether a program benefits depends on the school — programs that aggressively fund the new scholarship potential gain the most; programs that continue funding at 12 see no real change."
sources:
  ...
  - '<a href="https://www.usalacrosse.com/magazine/college/ncaa-schools-can-now-pay-athletes-directly-whats-it-mean-lacrosse">USA Lacrosse magazine</a> — "NCAA Schools Can Now Pay Athletes Directly. What''s it Mean for Lacrosse?"'
...
**What revenue sharing will look like for lacrosse athletes**. The benefits cap — $20.5 million per school in 2025-26 — is an institution-wide ceiling, not a per-sport allocation. The NCAA's House implementation Q&A says each Participating Institution "may provide benefits, at its discretion, to a student-athlete" so long as the combined value across all of its student-athletes stays under that cap. It does not divide the pool among sports. How much, if anything, reaches a lacrosse roster is therefore a decision each athletics department makes on its own — and it is not something any governing body publishes. Ask the program whether it receives revenue-share money at all, and if so what the figure was last year. See [NIL and Revenue Sharing](/guide/nil-and-revenue-sharing/) for the full set of questions to ask.
...
*House settlement implementation is still moving, and the money figures are dated. The revenue-sharing figures here reflect the **2025-26** academic year — the settlement's first year and the most recent for which the NCAA has published a cap — verified against the NCAA's House implementation Q&A (updated February 11, 2026) on 2026-08-26. That Q&A caps what a school may provide in total and leaves the split among sports to each institution's discretion; it publishes no allocation, and neither do we. Verify current roster and scholarship limits at NCAA.org, check benefits-cap rules with the College Sports Commission, and confirm what a specific program actually funds with its coaching staff.*
