...
description: "The complete men's college lacrosse recruiting timeline — from freshman year preparation through senior year commitment. Built around the September 1 junior year contact date with grade-by-grade family guidance."
date: 2026-06-14
breadcrumbs:
  - text: Home
    url: /
...
faq:
  ...
  - q: "My son is interested in Ivy League men's lacrosse — does the timeline differ?"
    a: "Ivy League programs follow the same NCAA D1 recruiting calendar for initial contact (September 1 of junior year). However, the Ivy League admissions process operates differently from non-Ivy D1 programs, and Ivy League schools do not offer athletic scholarships (need-based aid only)."
