---
layout: content.njk
title: "Weight-Class Depth & Class-Year Gaps — Wrestling Methodology | RosterWise™"
description: "The core fit question in wrestling is who occupies your weight and when they graduate. How RosterWise analyzes weight-class depth and class-year gaps to reveal where a program actually needs to recruit."
date: 2026-07-07
breadcrumbs:
  - text: Home
    url: /
...
1. **Map every wrestler to a weight class and class year** from the normalized roster (see [roster composition](/wrestling/methodology/roster-composition/)).
2. **Build a depth chart per weight** — starter, backups, redshirts where identifiable, and class years.
3. **Flag class-year gaps** — weights where the starter (and thin depth behind) point to a coming opening.
4. **Align to the recruit's projected weight and class year** — so the openings shown are the ones that actually matter for your athlete's timeline.
5. **Account for roster caps and portal patterns** — at D1, the 30-cap tightens the math; a portal-heavy program fills holes differently than a develop-your-own program.
