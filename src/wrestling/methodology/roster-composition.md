---
layout: content.njk
title: "Roster Composition Analysis by Weight Class — Wrestling Methodology | RosterWise™"
description: "How roster composition analysis works for college wrestling — reading a program's lineup weight by weight to understand its structure, needs, and recruiting patterns, and why it beats rankings for finding fit."
date: 2026-07-07
breadcrumbs:
  - text: Home
    url: /
...
This matters even more after the [House settlement](/wrestling/guide/scholarships-and-the-house-settlement/), which capped D1 rosters at 30. With a fixed roster size, every spot — and every weight — carries more weight.
...
1. **Start with the athlete's profile** — projected weight class, class year, geographic preference, target level.
2. **Filter programs** by division, geography, and academics.
3. **Analyze roster composition** at the remaining programs — looking for openings at the athlete's weight in the right class year.
4. **Prioritize outreach** to programs where the data shows genuine opportunity.
5. **Use the data in coach conversations** — "I noticed you're graduating your 157 and have no junior behind him" is a different conversation than "my kid wrestles 157."
6. **Revisit regularly** — rosters change through the season and the portal.
