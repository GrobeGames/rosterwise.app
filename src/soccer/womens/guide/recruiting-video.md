...
related:
  ...
  - title: "Women's College Soccer ID Camps"
    ...
    status: live
  - title: "Men's Soccer Recruiting Video Guide"
...
Because women's soccer recruiting tends to move earlier, video timing matters:

- **Have a working highlight reel ready by sophomore year.** Even before the June 15 contact date, you can send video to coaches (athletes can initiate contact at any time). A strong early video signals seriousness.
- **Update your video after each major showcase or competitive season.** Coaches want current footage — footage from 18 months ago loses relevance quickly.
- **Junior year is peak distribution time** for most women's recruits. This is when many programs are actively evaluating and making decisions.
- **Senior year video still matters** — particularly for D2, D3, and NAIA programs on later timelines.
...
- **Host the video on YouTube or Vimeo** (unlisted if you prefer). These platforms are universally accessible, work on any device, and don't require downloads.
- **Use a clear title:** "Jane Smith — Class of 2027 — Central Midfielder — Highlight Video" is better than "Soccer Highlights 2026."
- **Include an opening title card (5 seconds max)** with name, graduation year, position, club team, height, GPA, and contact information.
...
**Prioritize:**
- Competitive match footage from the highest level you play (ECNL Girls, GA, high school state tournament, etc.)
...
Different positions require different emphasis in a recruiting video.
...
**GK-specific tip:** Include footage from multiple angles if possible. And include sequences that show your positioning *before* the save — coaches evaluate the read as much as the reaction.
...
- For fullbacks: overlapping runs, crossing ability, defensive recovery
...
- Link-up play: combination play, hold-up play
...
- **Jersey number prominently displayed** in the opening card, with a note like "I'm #7 in blue"
...
**Timing matters:** In women's soccer, sending video during sophomore spring and summer (around the June 15 contact date) gives coaches film to review right when they can begin full recruiting conversations. Update and re-send during junior year as your best window for active recruiting communication.
