---
layout: content.njk
title: "What Women's College Soccer Coaches Look for by Position | RosterWise™"
description: "Position-by-position breakdown of what women's college soccer coaches evaluate — technical, tactical, physical, and mental attributes for goalkeepers, defenders, midfielders, and forwards."
date: 2026-04-26
breadcrumbs:
  - text: Home
    url: /
...
related:
  ...
  - title: "Women's College Soccer ID Camps"
    ...
    status: live
  - title: "Men's Soccer: What Coaches Look For"
...
Before getting into position-specific attributes, there are qualities that virtually every women's college soccer coach evaluates:
...
- Dealing with crosses — positioning, timing of jumps, decision-making
- Communication — vocal presence, directing the defensive line, calling for the ball
- Managing set pieces — positioning on corners and free kicks, organizing the wall
- Authority — does the goalkeeper project confidence and control?

**Physical profile:**
- Height matters for goalkeepers more than any other position — but there is no hard minimum. Taller goalkeepers have natural advantages on crosses and in closing angles, but shorter goalkeepers with exceptional reflexes and positioning succeed at every level of women's college soccer.
- Wingspan, agility, and explosiveness are evaluated alongside height.

**Mental attributes:**
- Concentration — staying focused during long stretches without action
...
For a deeper dive into GK-specific recruiting, see the [goalkeeper recruiting guide](/soccer/womens/guide/goalkeeper-recruiting/).
...
- Tackling technique — clean, well-timed tackles
...
**Physical profile:**
- Size can be an advantage at center back — height and strength help in aerial duels — but speed and reading of the game can compensate. Women's college soccer has produced outstanding center backs across a range of physical profiles.
- Speed is increasingly valued as the game emphasizes higher defensive lines.
...
The fullback role in women's college soccer mirrors the evolution happening across the sport globally. Modern fullbacks are expected to contribute significantly in attack.
...
**Physical profile:**
- Speed and endurance are paramount — fullbacks cover significant ground in a typical match
- The modern game values fullbacks who can run box-to-box repeatedly

**Versatility:**
- Can the player play on both sides?
- Can they adapt to different tactical systems (3-5-2 wingback vs. 4-3-3 fullback)?

## Central midfielders

Central midfield is the engine room, and evaluation varies based on whether the role is defensive, box-to-box, or attacking.
...
- Reading of the game — anticipating transitions
...
**Physical profile:**
- Varies by role — holding midfielders may prioritize strength and positioning; attacking midfielders may prioritize agility and quickness
- Endurance is essential across all central midfield roles

## Wingers and wide midfielders

Wingers are often the most eye-catching players on a highlight video, but coaches evaluate more than speed and dribbling.

**Attacking qualities:**
- One-on-one ability — taking on defenders with dribbling, pace, or skill
- End product — goals, assists, and quality of final ball
- Movement — finding space, timing of runs, understanding of when to go wide vs. cut inside
...
Forwards are evaluated primarily on their ability to score and create goals, but the role encompasses more than finishing.
...
- Defensive positioning during set pieces and sustained pressure
- Willingness to run channels and stretch the defense even when the ball isn't coming

**Physical profile:**
- Varies enormously by type of forward — a target forward's physical profile is very different from a quick, mobile forward
...
**D1:** Physical attributes — speed, size, endurance — carry more weight at the D1 level. The game is faster, more physical, and less forgiving. Technical quality is still essential, but physical tools matter at D1 speed.

**D2:** Similar to D1 but with more tolerance for physical development still in progress. Tactical intelligence and technical quality can offset physical gaps more than at D1.

**D3:** Technical quality, tactical intelligence, and character tend to be weighted more heavily relative to pure physical attributes. D3 programs often value the "complete student-athlete" who excels in the classroom and contributes to campus culture alongside athletic performance.
...
- **Academic eligibility is a filter, not a tiebreaker.** Players who don't meet minimum academic standards are eliminated before athletic evaluation begins.
...
Men's college soccer coaches evaluate many of the same attributes, but the physical profile expectations, tactical emphasis, and positional dynamics differ. If you're navigating men's recruiting, [here's the men's version](/soccer/mens/guide/what-coaches-look-for/).
