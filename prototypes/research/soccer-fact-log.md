...
3. **The "non-opt-in schools keep the old limits" sentences (§B, last row).**
   The 2026-27 D1 Manual has no sport-specific aid limits for anyone. Five pages
   tell families otherwise. Establish what actually governs a non-participating
   institution's aid today, then rewrite all five together.
