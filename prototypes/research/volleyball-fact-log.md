...
| ⚠️ **THIS INSTRUCTION IS NOW STALE — superseded 2026-08-28.** The row previously read "§5.6 done right — keep this wording" for: "As of 2026, no separate D2 championship has been launched. The status of any such proposal in the coming years is not yet clear from public NCAA documentation." That was honest when written, but the status **is** now clear from public NCAA documentation. On 2026-08-06 the Division II Executive Board "sponsored legislation for the 2027 NCAA Convention to establish a Division II Men's Volleyball Championship and create a Division II Men's Volleyball Committee," and "if the proposal is adopted in January by the Division II membership, the committee would begin its work immediately, with the first championship projected for spring 2029." §4.2 expressly permits reporting what is **scheduled and sourced**, so the copy now states the vote and the spring-2029 projection rather than declining to. **Lesson for the next pass: a "keep this wording" instruction is itself perishable** — it must be re-checked against the source on every staleness pass, exactly like a number. | **NCAA.org — "Division II Executive Board advances championship enhancements, approves 2026-27 priorities" (2026-08-06)**, the same release already cited on `volleyball/mens/index` for its "36 schools" figure | 2026-08-28 | volleyball/mens/guide/national-collegiate-championship (lines 98 and 106 rewritten) |
...
| ✅ **FIXED 2026-08-28.** Previously read: "The 2025 House v. NCAA settlement increased the NCAA D-I women's volleyball roster cap from the previous 12-scholarship head count structure to an 18-player equivalency roster." There was **no** roster cap in Division I before the settlement; 12 was a limit on how many players could receive athletics aid, not a roster limit. The corrected copy now states that the settlement **created** the 18-player limit and **removed** the sport-specific scholarship limit, and that rosters contracted against a new ceiling. The dependent inference ("may increase transfer opportunities as D-I programs have more roster spots to fill") was deleted from both places it appeared. | NCAA.org, "DI Board of Directors formally adopts changes to roster limits" (2025-06-23): "NCAA rules for Division I programs will no longer include sport-specific scholarship limits. Instead, schools ... will have roster limits." NCAA "Q&A: Implementation of the House Settlement" (published 2025-06-13), Question D6, p.20: "in 2024-25, an institution could provide any amount of countable financial aid to up to 12 women's volleyball student-athletes." Also 2026-27 D1 Manual Bylaw 17.2 (adopted 6/6/25 — no prior roster limitation) | 2026-08-28 | volleyball/guide/juco-pathway (three occurrences corrected; line 99 was already correct and the corrected text now matches it) |
...
6. ~~**"The 12-scholarship head count structure" described as a roster cap (§J).**
   ...
   **CLOSED 2026-08-28.** All three occurrences on `volleyball/guide/juco-pathway`
   rewritten against the NCAA's 2025-06-23 roster-limits release and the House
   implementation Q&A (D6). The dependent transfer-opportunity inference was
   deleted rather than rephrased.
