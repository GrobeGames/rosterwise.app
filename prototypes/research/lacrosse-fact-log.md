...
| ❌ **PUBLISHED ERROR — "Official visits [for D1 women's lacrosse] begin January 1 of junior year."** The current bylaw says otherwise: "In baseball and women's lacrosse, a prospective student-athlete may not be provided an expense-paid visit earlier than **September 1 (12 p.m. Eastern time for women's lacrosse)** of the prospective student-athlete's junior year in high school." **January 1 of junior year is the DIVISION III rule** (D3 Bylaw 13.6.1.1.1) — it appears to have been attached to D1 women's lacrosse by mistake. The men's page repeats it as a contrast ("This differs from women's lacrosse, where official visits begin January 1"), and `womens/guide/international-recruiting` attributes it to the 2026-27 women's lacrosse calendar, **which contains no such date**. | **2026-27 NCAA D1 Manual, Bylaw 13.6.2.1.2** (Revised 6/24/26, 6/29/26 effective 8/1/26); D3 Manual Bylaw 13.6.1.1.1 for the January 1 rule it was confused with | 2026-08-28 (**blast radius reworked** — the 2026-08-26 pass fixed the three lacrosse pages and missed two sport-agnostic guide pages carrying the same claim; found by grep, not by this row's Articles column) | lacrosse/womens/guide/recruiting-timeline:10, :153; lacrosse/womens/guide/international-recruiting:51; lacrosse/mens/guide/recruiting-timeline:23, :174; **guide/ncaa-recruiting-rules:138 (fixed 2026-08-28)**; **guide/official-vs-unofficial-visits:50 (fixed 2026-08-28)**. NOT affected — these state the January 1 date correctly as the **Division III** rule: guide/division-differences:84 and :120, guide/ncaa-recruiting-rules:181, guide/official-vs-unofficial-visits:65, soccer/mens/guide/recruiting-timeline:163, soccer/womens/guide/recruiting-timeline:171, volleyball/womens/guide/recruiting-timeline:162 |
...
| ✅ **CORRECTED 2026-08-28 — the roster-reduction arithmetic is a FORECAST, and the copy stated it as a completed outcome.** USA Lacrosse published it the day the settlement was approved, in the future tense: "The average NCAA Division I men's lacrosse roster in 2024 was 52.7 players, meaning that moving forward, an average of 4.7 players per team - approximately 362 players overall - **will lose** the opportunity to compete at the Division I level." All three pages said players "lost" the opportunity "when the new caps took effect." All three now restore the source's tense and label it a forecast; the DSA exemption is noted alongside. The 52.7/34.7 averages remain Tier 2 and unverifiable first-party (RosterWise's dataset begins 2025-26, the first season under the caps). | **USA Lacrosse magazine — "NCAA Schools Can Now Pay Athletes Directly. What's it Mean for Lacrosse?", Brian Logue, 2025-06-06** (`usalacrosse.com/magazine/college/ncaa-schools-can-now-pay-athletes-directly-whats-it-mean-lacrosse`), read in full; `roster-data-fact-log.md` confirms no pre-House rosters exist in the dataset | 2026-08-28 | lacrosse/guide/house-settlement-and-lacrosse, lacrosse/mens/guide/scholarships-after-house-settlement, lacrosse/mens/guide/recruiting-timeline |
| ❌ **MISATTRIBUTION, CORRECTED 2026-08-28 — the five-category distribution is Bill Tierney's, not John Tillman's.** USA Lacrosse ("What the NCAA Antitrust Settlement Means for College Lacrosse," Justin Feil, 2024-08-01) reads: "Former Denver men's lacrosse coach and current IMLCA president Bill Tierney sees the breakdown going further. A first group could increase scholarships to something like 25, he said. A second group could continue to support what previously existed. A third group would remain in Division I but not even match the 12.6/12 scholarships limit. A fourth group would eliminate scholarships and go club. And the fifth level that drops lacrosse entirely." Tillman's only quotes in that piece are the "scuttlebutt ... I just don't see that happening" line about 48 scholarships and a remark about institutional tiering. Reattributed to Tierney with his stated title on the three men's-side pages. **Both women's-page instances were cut entirely** — they repurposed a men's-side quote about scholarship counts into a women's-page prediction that programs may eliminate the sport (§4.2 and §4.6). A quote-boundary error was also fixed on `mens/scholarships-after-house-settlement`: "That's because there are massive financial ramifications..." is the article's narration, not Tillman's words, and had been folded inside his quotation marks. The "more than 2,500 additional scholarships" count and the Sports Illustrated 216% table remain Tier 2 and unverified against Tier 1. | USA Lacrosse magazine, 2024-08-01 article read in full 2026-08-28; Sports Illustrated (Tier 2) | 2026-08-28 | lacrosse/mens/guide/scholarships-after-house-settlement, lacrosse/mens/guide/recruiting-timeline, lacrosse/guide/house-settlement-and-lacrosse (women's-page instances removed) |
